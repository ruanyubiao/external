...
public:
    ...
    long GetLong(std::string section, std::string name, long default_value) const;

    template<typename T>
    T GetInteger(std::string section, std::string name, long default_value) const;
...
inline long INIReader::GetLong(std::string section, std::string name, long default_value) const
{
...
template<typename T>
inline T INIReader::GetInteger(std::string section, std::string name, long default_value) const
{
    auto value = GetLong(section, name, default_value);
